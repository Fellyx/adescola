class ResponsaveisController < ApplicationController
  ...
  def destroy
    @responsavel.destroy
    respond_to do |format|
      format.html { redirect_to responsaveis_url, notice: 'Responsavel was successfully destroyed.' }
  ...
  private
    ...
    def responsavel_params
      params.require(:responsavel).permit(:nome, :data_de_nascimento, :sexo, :cpf, :cep, :endereco, :complemento, :bairro, :cidade, :uf, :telefone, :email, :foto)
    end
end
